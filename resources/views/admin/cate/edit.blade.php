...
@section('content')
    ...
    <div class="panel admin-panel margin-top" id="add">
        ...
        <div class="body-content">
            <form method="post" id="form" class="form-x" action="{{url('admin/cate/'.$cate['id'])}}">
                @csrf
                {{method_field('put')}}
                <div class="form-group">
                    ...
                    <div class="field">
                        <input type="text" class="input w50" value="{{$cate['name']}}" name="name" datatype="s2-10"/>
                        <div class="tips"></div>
                    </div>
                </div>
                <div class="form-group">
