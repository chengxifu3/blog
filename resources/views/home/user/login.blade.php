                                ...
                                <form method="POST" id="form" action="{{url('login')}}" accept-charset="UTF-8">
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <input class="form-control" name="username" type="text" value=""
                                               datatype="s2-10" placeholder="请填写用户名"/>
                                    </div>
                                    <div class="form-group ">
                                        <label class="control-label" for="password">密 码</label>
                                        <input class="form-control" name="password" type="password" datatype="s6-12"
                                               value="" placeholder="请填写密码"/>
                                    </div>
                                    <div class="form-group ">
                                    ...
                                    <button type="submit" class="btn btn-lg btn-success btn-block"><i
                                                class="fa fa-btn fa-sign-in"></i> 登录
                                    </button>
                                    <hr/>
